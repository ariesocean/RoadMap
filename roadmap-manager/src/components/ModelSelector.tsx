...
const PROVIDER_COLORS: Record<string, { dot: string, text: string }> = {
  ...
  'opencode': { dot: 'bg-blue-500', text: 'text-blue-500 dark:text-sky-240' },
  'openrouter': { dot: 'bg-emerald-500', text: 'text-emerald-600 dark:text-emerald-300' },
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      <button
        ...
        className={`
          flex items-center gap-1.5 sm:gap-2 md:gap-2.5 px-2 sm:px-2.5 md:px-3 py-1 sm:py-1.25 md:py-1.5 rounded-lg text-[11px] sm:text-[11.5px] md:text-xs font-medium
      ...
      >
        ...
        <span className="opacity-60 hidden sm:inline md:inline">{formatProviderName(currentModel.providerID)}</span>
